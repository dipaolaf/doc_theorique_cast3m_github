...
- `Jeu de données Cast3M <../.././rotor_laval_poutre.dgibi>`_
- `Fichier graphique résultat pour le cas avec 5 modes <../.././rotor_laval_poutre-5.pdf>`_
- `Fichier graphique résultat pour le cas avec 9 modes <../.././rotor_laval_poutre-9.pdf>`_
